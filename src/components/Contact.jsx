...
const Contact = () => {
  return (
    <section
        id="contact"
        className='section flex items-center justify-center py-16 lg:py-24'
        
        >
            <div className="conatiner lg:grid lg:grid-cols-2 lg:items-stretch gap-8 max-w-6xl">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                        Contact me for collaboration
                    </h2>
                    <p className="tex-zinc-400 mt-3 mb-8 max-w-[50ch] lg.max-w-[30ch] reveal-up">
                ...
                <form
                    action="https://getform.io/f/apjjopra"
                    method="POST"
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name"
                                autoComplete='name'
                                required
                                placeholder="Pawan Kumar" className="text-field reveal-up" />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email"
                                autoComplete='email'
                                required
                                placeholder="pawan@example.com" className="text-field reveal-up" />
                        </div>
                    </div>
                    <div className="mb-4">
                        <label 
